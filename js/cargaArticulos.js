...
function filtrarTenisNino() {
    let articulosContainer = document.getElementById("menu-container-id");
    let htmlDinamico = "";
    datos.articulos.forEach(articulo => {
        if (articulo.clasificacion == "tennisninos") {
            htmlDinamico += "<div class='col'>";
            htmlDinamico += "<div class='card card-cover h-75 overflow-hidden text-bg-dark rounded-10 shadow-lg m-10' style=\"background-image: url('" + articulo.imagen + "');\">";
...
function filtrarEscolarNino() {
    let articulosContainer = document.getElementById("menu-container-id");
    let htmlDinamico = "";
    datos.articulos.forEach(articulo => {
        if (articulo.clasificacion == "Escolarninos") {
            htmlDinamico += "<div class='col'>";
            htmlDinamico += "<div class='card card-cover h-75 overflow-hidden text-bg-dark rounded-10 shadow-lg m-10' style=\"background-image: url('" + articulo.imagen + "');\">";
            htmlDinamico += "<div class='d-flex flex-column h-100 p-5 pb-5 ml-5 mt-5 text-white text-shadow-1'>";
            htmlDinamico += "<h4 class='display-6 lh-1 fw-bold m text-center'>" + articulo.nombre + "</h4>";
...
function filtrarMocasHombre() {
    let articulosContainer = document.getElementById("menu-container-id");
    let htmlDinamico = "";
    datos.articulos.forEach(articulo => {
        if (articulo.clasificacion == "mocasinhombre") {
            htmlDinamico += "<div class='col'>";
            htmlDinamico += "<div class='card card-cover h-75 overflow-hidden text-bg-dark rounded-10 shadow-lg m-10' style=\"background-image: url('" + articulo.imagen + "');\">";
            htmlDinamico += "<div class='d-flex flex-column h-100 p-5 pb-5 ml-5 mt-5 text-white text-shadow-1'>";
            htmlDinamico += "<h4 class='display-6 lh-1 fw-bold m text-center'>" + articulo.nombre + "</h4>";
...
function filtrarBurrosHombre() {
    let articulosContainer = document.getElementById("menu-container-id");
    let htmlDinamico = "";
    datos.articulos.forEach(articulo => {
        if (articulo.clasificacion == "burrohombre") {
            htmlDinamico += "<div class='col'>";
